...
# Ensure the API key is set from environment variable
...
def validate_user_data(user_data):
    required_fields = ['age', 'gender', 'weight_kg', 'height_cm', 'diet_type', 'goal', 'location', 'living_type', 'daily_budget']
...
def api_generate_meal_plan():
    try:
        ...
        user_data.setdefault('allergies', ['none'])
        user_data.setdefault('food_sources', ['none'])
        user_data.setdefault('cooking_access', 'none')
        user_data.setdefault('utensils', ['none'])
        user_data.setdefault('food_storage', 'none')
        user_data.setdefault('mess_rules', ['none'])
        user_data.setdefault('cuisines', ['none'])
        user_data.setdefault('favorite_foods', ['none'])
        user_data.setdefault('hated_foods', ['none'])
        user_data.setdefault('spice_level', 'medium')
        user_data.setdefault('hostel_provides_food', 'NO')
        user_data.setdefault('hostel_food_times', '0/0/0')
